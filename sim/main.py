...
def main():
    ...
    plot_overview_dashboard(round_data, save_path=img("01_overview.png"))
    plot_legion_detail(allied, enemy, save_path=img("02_legion_detail.png"))
    plot_battle_results(summaries, save_path=img("03_battle_results.png"))
    plot_commander_status(allied, enemy, save_path=img("04_commanders.png"))
    plot_stat_radar(allied, enemy, save_path=img("05_radar.png"))
    plot_morale_timeline(allied, enemy, save_path=img("06_morale_timeline.png"))
    plot_graveyard(allied, enemy, summaries, save_path=img("07_graveyard.png"))
    plot_death_toll(round_data, save_path=img("08_death_toll.png"))
    ...
    if args.monte_carlo > 0:
        _, all_death_events = plot_monte_carlo(
            ...
            legions_path=args.legions,
            commanders_path=args.commanders,
        )
        plot_cmdr_deaths_analysis(
            all_death_events, num_sims=args.monte_carlo, save_path=img("97_cmdr_deaths.png")
        )
        plot_balance_analysis(
            legions_path=args.legions,
            commanders_path=args.commanders,
